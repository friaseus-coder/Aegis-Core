...
class FinalizeSetupUseCase @Inject constructor(
    ...
    suspend operator fun invoke(name: String, language: String, pin: String, role: com.antigravity.aegis.data.model.UserRole, seedPhrase: List<String>, masterKey: ByteArray): Result<Unit> {
        val saveResult = authRepository.createAdmin(name, language, pin, role, seedPhrase, masterKey)
